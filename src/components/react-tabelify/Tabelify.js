...
class Tabelify extends React.Component{
    ...
    sortDataOnColumn (data) {
        ...
        data.sort((a, b)=> {
            if (this.props.sortColumn === '')
                console.log('this.props.sortColumn', this.props.sortColumn)
                return data;
    ...
    render () {
        console.log('dataTab', this.props.data)
        ...
        return (
            ...
            {
                    this.props.localSearch === true?
                        <input type="SmartInput" placeholder="search"
                                //value={this.state.search}
                               className="grid-search" onChange={this.searchHandler}/>
                    :null
                }
